...
/* harmony import */ var rxjs_add_operator_finally__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/add/operator/finally */ "./node_modules/rxjs-compat/_esm2015/add/operator/finally.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"], { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: XhrInterceptor, multi: true }],
...
let AppService = class AppService {
    ...
    register(credentials, callback) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"](credentials ? {
            authorization: 'Basic' + btoa(credentials.firstName + ':'
...
let RegisterComponent = class RegisterComponent {
    constructor(app, http, router) {
        ...
        this.http = http;
        this.router = router;
        this.credentials = { firstName: '', lastName: '', email: '', username: '', password: '' };
    }
    ngOnInit() {
    }
    register() {
...
module.exports = __webpack_require__(/*! /Users/sebastiandomarbolmstam/Documents/KTH - Courses/II1201-Design_of_global_applications/project/iv1201/angular/recruitment-application/src/main.ts */"./src/main.ts");
